...
keeps `host-b/node-b` in standby until controller activation gates pass, and treats
...
3. Treat `host-a/node-a` as the merge-blocking `primary-testing` environment for
