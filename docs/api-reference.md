...
| Temporal workflows | `/api/v1/workflows/product-publish`, `/api/v1/workflows/content-generation`, `/api/v1/workflows/media-processing`, `/api/v1/workflows/sourcing`, `/api/v1/workflows/{id}`, `/api/v1/workflows/{id}/signals/review` | Durable workflow starts, status lookup, and human-review signal contracts. See `docs/temporal-workflow-specs.md`. |
