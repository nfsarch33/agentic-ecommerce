...
Keys are stored in **1Password Cursor_IronClaw vault**:

| Alias | 1Password Item | Env Var |
|-------|---------------|---------|
| `minimax-api-1` | `minimax-api-1` in Cursor_IronClaw | `EC_MINIMAX_API_KEY_1` |
| `minimax-api-2` | `minimax-api-2` in Cursor_IronClaw | `EC_MINIMAX_API_KEY_2` |
...
export EC_MINIMAX_API_KEY_1="$(op read 'op://Cursor_IronClaw/minimax-api-1/credential')"
export EC_MINIMAX_API_KEY_2="$(op read 'op://Cursor_IronClaw/minimax-api-2/credential')"
```
